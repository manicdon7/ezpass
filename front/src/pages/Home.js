        ...
        <div className="h-screen play-font" style={bg}> 
            <main className="grid grid-cols-2">
                <div className="text-white font-semibold  mt-36 ml-10 poppins-font"> 
                    ...
                    <p className="text-lg  mt-8 mr-28">Experience seamless event hosting and ticket booking with EasyPass  Embrace the future of ticketing - Your hassle-free ticketing solution!</p>
                    <a href="/events">
